      ...
      mount_points = [
        {
          ...
          containerPath = "/usr/share/nginx/html" # Default NGINX static content directory
        }
      ]

      entry_point = ["/docker-entrypoint.sh"]

      # Example commands to start NGINX and keep it in the foreground
      command = ["nginx", "-g", "daemon off;"]

      # NGINX runs without requiring write access to the root filesystem
